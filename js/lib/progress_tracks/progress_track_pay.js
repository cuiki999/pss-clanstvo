...
var donePay = document.getElementById('send-payment');
var skippedPay = document.getElementById('skip-payment'); // progress bar circles in payment.html

var payC1 = document.getElementById('pay-c-1');
var payC2 = document.getElementById('pay-c-2');
var payC3 = document.getElementById('pay-c-3');
var payC4 = document.getElementById('pay-c-4'); // progress bar labels in payment.html (numbers inside the circles)

var payL1 = document.getElementById('pay-l-1');
var payL2 = document.getElementById('pay-l-2');
var payL3 = document.getElementById('pay-l-3');
var payL4 = document.getElementById('pay-l-4'); // unless the step has been done, the current circle is always active - orange color
...
giveClass('fin', payC4, payL4); // if a step hasn't been accessed yet, the link to it becomes deactivated
...
disableLink('fin', payC4); // if you finish the step, the local storage gets the value 'ok' for that step so that you can use it later
